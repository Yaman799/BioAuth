"""Compatibility wrapper for :mod:`bioauth.release.local_data_backup`.

Commercial-CLEAN-05 moved the implementation into ``src/bioauth/release``.
Keep importing ``local_data_backup`` from the repository root until a later phase
...
_module = _importlib.import_module("bioauth.release.local_data_backup")
