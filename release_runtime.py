"""Compatibility wrapper for :mod:`bioauth.release.release_runtime`.

Commercial-CLEAN-05 moved the implementation into ``src/bioauth/release``.
Keep importing ``release_runtime`` from the repository root until a later phase
...
_module = _importlib.import_module("bioauth.release.release_runtime")
