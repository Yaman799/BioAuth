"""Compatibility wrapper for :mod:`bioauth.release.support_bundle`.

Commercial-CLEAN-05 moved the implementation into ``src/bioauth/release``.
Keep importing ``support_bundle`` from the repository root until a later phase
...
_module = _importlib.import_module("bioauth.release.support_bundle")
