"""Compatibility wrapper for :mod:`bioauth.release.update_client`.

Commercial-CLEAN-05 moved the implementation into ``src/bioauth/release``.
Keep importing ``update_client`` from the repository root until a later phase
...
_module = _importlib.import_module("bioauth.release.update_client")
